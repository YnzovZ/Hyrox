      ...
      >
        <div className="mb-4 flex items-start justify-between">
          <div>
            ...
            <h2 className="mt-1 text-2xl font-bold">{station.name}</h2>
        ...
        <p className="mb-4 text-base text-zinc-600 dark:text-zinc-300">{station.description}</p>
        ...
        <ul className="mb-4 space-y-1.5">
          {station.tips.map((tip, i) => (
            <li key={i} className="flex items-start gap-2 text-base text-zinc-600 dark:text-zinc-300">
        ...
        <div className="mb-4 flex flex-wrap gap-1.5">
          {station.muscles.map((muscle) => (
            <span
              key={muscle}
              className="rounded-full bg-zinc-100 px-2.5 py-1 text-sm font-medium text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300"
            >
              {muscle}
            </span>
          ))}
        ...
        {station.videoUrl && (
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-50 py-3 text-base font-semibold text-red-700 transition-colors hover:bg-red-100 dark:bg-red-950/30 dark:text-red-400 dark:hover:bg-red-950/50"
          >
  ...
  return (
    <main className="mx-auto max-w-lg px-4 pt-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold tracking-tight">Hyrox Stations</h1>
