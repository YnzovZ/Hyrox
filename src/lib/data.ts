    ...
    // WEEK 3 - Base 1
    {
      ...
      days: [
        ...
        },
        {
          ...
          exercises: [
            { name: "Front Squat", sets: 3, reps: "8", rest: "90 sec" },
            { name: "Romanian Deadlift", sets: 3, reps: "10", rest: "60 sec" },
            { name: "Overhead Press", sets: 3, reps: "10", rest: "60 sec" },
    ...
    // WEEK 9 - Build 1
    {
      ...
      days: [
        ...
        },
        {
          ...
          exercises: [
            { name: "Front Squat", sets: 3, reps: "10", rest: "90 sec" },
      ...
      days: [
        {
          ...
          difficulty: "moderate",
          duration: "40 min",
          description: "Laatste stevige hardlooptraining. Lekker op tempo, houd het comfortabel.",
          exercises: [
            { name: "Warm-up", duration: "10 min" },
            { name: "Tempo Run", duration: "20 min", notes: "75% effort" },
            { name: "Cool-down", duration: "10 min" },
          ],
        },
        {
          ...
          difficulty: "moderate",
          duration: "40 min",
          description: "Lichter circuit. Volume gaat omlaag, je lichaam begint op te laden.",
          exercises: [
            { name: "Wall Balls", reps: "12" },
            { name: "Kettlebell Swings", reps: "10" },
            { name: "Mountain Climbers", reps: "15" },
            { name: "Rowing", distance: "200m" },
            { name: "Goblet Squat", reps: "8", notes: "2 rondes, 2 min rust tussen rondes" },
          ],
        },
        {
          day: 6,
          title: "Halve Sim Smooth",
          type: "hyrox",
          difficulty: "moderate",
          duration: "50 min",
          description: "Halve simulatie op comfortabel tempo. Geen records, wel flow.",
          exercises: [
            { name: "Run", distance: "1 km" },
            { name: "SkiErg", distance: "1000m" },
            { name: "Run", distance: "1 km" },
    ...
    // WEEK 19 - Race Week
    {
      ...
      days: [
        ...
        },
        {
          ...
          difficulty: "race",
          duration: "60-90 min",
          description: "Dit is het. 19 weken training komen samen. Geniet ervan, Ynzo.",
          exercises: [
